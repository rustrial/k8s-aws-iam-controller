...
COPY --from=builder /workdir/target/release/rustrial-k8s-aws-iam-controller /usr/local/bin/rustrial-k8s-aws-iam-controller

ENTRYPOINT [ "/usr/local/bin/rustrial-k8s-aws-iam-controller" ]
